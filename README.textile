...
These marks represent Textile, the markup language created by "Dean Allen":http://alistapart.com/author/deanallen in "2002":https://web.archive.org/web/20021226035527/http://textism.com/tools/textile/. For nearly 13 years, no satisfactory mark existed for writers, designers, and developers to use, now one does.
...
File contributions are welcome. Submit them as pull requests to this repo. Such contributions may include, .png icon sets, SVG files, file size reductions, or any other form or version that might be useful and in accordance with the specifications above.
